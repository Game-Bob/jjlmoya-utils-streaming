...
const UTILITY_ASSET_ROOT = "/_utilities/streaming";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/streaming/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/streaming/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("streaming");
